...
pub const slash_specs = [_]SlashSpec{
    ...
    .{ .kind = .login, .command = "/login", .help_entry = "/login", .completion_description = "choose Vercel, Codex, or SuperGrok sign-in", .presentation_category = .account },
    ...
    .{ .kind = .provider, .command = "/provider", .help_entry = "/provider [gateway|codex|anthropic|xai]", .completion_description = "choose Gateway, Codex, Anthropic, or SuperGrok", .presentation_category = .model, .has_args = true, .accepts_payload = true },
