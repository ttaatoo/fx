...
This fork can also use Anthropic Messages and xAI Chat Completions without Vercel AI Gateway. That path is a fork experiment. See [Direct LLM providers](docs/direct-providers.md) for `~/.fx/providers.json`, environment variables, and Claude Code proxy examples.
